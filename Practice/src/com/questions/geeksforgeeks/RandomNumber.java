...
//		int array5[] = {4,5,6,7};
		...
		for (int i = 0; i < 25; i++)
		{
			...
			if (num == 0 || num == 1 || num == 2){
				ans = array0[n.getRandom(5) % 4];
			}
			else
			{
				ans = array3[n.getRandom(5) % 4];
			}
			//ans = num * n.getRandom(5) % 8;
			System.out.println(num+" Mapped to "+ans);
...
class MyRandom implements java.io.Serializable {
     ...
     */
    public MyRandom() { this(++seedUniquifier + System.nanoTime()); }
