...
import com.practice.trees.binarytree.*;;
...
public class TreeImpl
{
	...
	public void getLCA(int value1, int value2)
	{
		Node temp = start;
		if (temp == null)
			return;
		
		Node data = getLCA(temp, value1, value2);
		System.out.println(data.getData());
	}
	
	private Node getLCA(Node temp, int value1, int value2)
	{
		if (temp == null)
			return temp;
		
		if (temp.getData() == value1 || temp.getData() == value2)
			return temp;
		
		Node left = getLCA(temp.getleft(), value1, value2);
		Node right = getLCA(temp.getRight(), value1, value2);
